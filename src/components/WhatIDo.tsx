        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>Description</h4>
              <p>
                Conducting exploratory data analysis (EDA), building predictive models, and developing Generative AI applications to derive actionable insights and automate workflows.
              </p>
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>Description</h4>
              <p>
                Designing and building robust, scalable applications, with a strong focus on data structures, algorithms, and clean architecture.
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
